	...
	const getPromptFill = (prompt: string): string => {
		...
		const fill: FillType = {
			...
			profession: [
				...
				'chief meme officer',
				'wizarding supplies specialist',
				'chief unicorn herder',
				'chief mischief officer',
				'master of pranks',
				'head of bubble wrap design',
				'supreme pizza critic',
				'chief adventure officer',
				'executive doodler',
				'celestial cartographer',
				'vibe curator',
				'supreme happiness engineer',
				'ambassador of laughter',
				'chief of whimsy',
				'master of chill vibes',
				'chief of silliness',
				'professor of awesomeness',
				'chief of shenanigans',
				'head of dream weaving',
				'captain of the laughter brigade',
				'supreme doodle artist',
				'chief of imagination',
				'commander of the dance floor',
				'architect of joy',
				'chief of wonderment',
				'executive dreamweaver',
				'captain of cheerfulness',
				'sultan of sparkle',
				'jester of joy',
		...
		return (
			fill[closestKey][Math.floor(Math.random() * fill[closestKey].length)] || ' '
		);
	};
